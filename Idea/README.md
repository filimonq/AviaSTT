...
| ------------- | ------------- | ------------- | ------------- | ------------- |  ------------- |
| Из-за высокого уровня шума в кабине пилота и невысокого качества микрофонов диспетчеры не всегда могут четко расслышать команды пилотов. Это может привести к задержкам в переговорах,недопонимаю между диспетчером и экипажем самолета, а иногда даже к потенциально опасным ситуациям. | Пилоты, диспетчеры аэропортов, авиакомпании (например, S7 Airlines)  | Приложение для транскрипции авиационных переговоров в реальном времени. Оно использует алгоритмы  распознавания речи, адаптированные под фразеологию ICAO, чтобы преобразовывать речь пилота в текст и передавать его диспетчеру. | - **Google Speech-to-Text** (не аддаптивен для ICAO)<br>- **Stratus Insight** (приложение платное) | <p style="text-align: center;">**Адаптация под ICAO**: Система обучена на авиационной терминологии, что повышает точность распознавания.</p>  | Разместите демонстрацию вашего продукта на любом ресурсе и прикрепите ссылку в документ для просмотра | 
